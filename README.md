...
| --- | --- | --- |
| English (`en-US`) | 500/500 | 100% |
| Deutsch (`de`) | 475/500 | 95% |
| Français (`fr`) | 475/500 | 95% |
| Italiano (`it`) | 475/500 | 95% |
| Русский (`ru`) | 475/500 | 95% |
| Українська (`uk`) | 475/500 | 95% |
| Polski (`pl`) | 475/500 | 95% |
| Português (Brasil) (`pt-BR`) | 496/500 | 99% |
