...
settings-lastfm-off = Non connecté
settings-lastfm-waiting = En attente de Last.fm dans votre navigateur…
settings-lastfm-as = Scrobbling sous { $name }
settings-lastfm-failed = Connexion à Last.fm impossible
settings-lastfm-connect = Connecter
settings-lastfm-disconnect = Déconnecter
settings-lastfm-title = Connecter Last.fm
settings-lastfm-title-detail = Sonora scrobble via votre propre compte API Last.fm. Créez en un, puis collez ici la clé et le secret.
settings-lastfm-key = Clé API
settings-lastfm-secret = Secret API
settings-lastfm-request = Obtenir une clé API
