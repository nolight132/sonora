...
login-cookie-hint = Wklej tutaj nagłówki żądania lub wartość Cookie
login-cookie-step-1 = Otwórz music.youtube.com, zaloguj się i przełącz na konto marki, którego chcesz użyć.
...
login-cookie-step-4 = Skopiuj cały blok Nagłówki żądania i wklej go poniżej.
login-cookie-step-note = Konta marki wymagają X-Goog-PageId. Skopiowane nagłówki muszą też zawierać Cookie z SAPISID lub __Secure-3PAPISID.
