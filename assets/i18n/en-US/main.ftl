...
login-cookie-hint = Paste the request headers or Cookie value here
login-cookie-step-1 = Open music.youtube.com, sign in, and switch to the Brand Account you want to use.
...
login-cookie-step-4 = Copy the complete Request Headers block and paste it below.
login-cookie-step-note = Brand Accounts require X-Goog-PageId. The copied headers must also contain Cookie with SAPISID or __Secure-3PAPISID.
