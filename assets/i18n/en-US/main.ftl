...
settings-discord-detail = Share the track you are listening to on Discord; clears when paused
settings-discord-label = Discord application label
settings-discord-label-detail = Use Sonora or automatically match your connected music platform
settings-discord-label-sonora = Sonora
settings-discord-label-auto = Auto-Detect
